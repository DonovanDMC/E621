...
export const DBExportNameSchema = {
    type: 'string',
    enum: [
        'artists',
...
export const EditHistoryVersionableTypeSchema = {
    type: 'string',
    enum: [
        'Blip',
        'Comment',
...
export const JWKSAlgorithmSchema = {
    type: 'string',
    enum: [
        'RS256'
    ]
...
export const ModActionActionSchema = {
    type: 'string',
    enum: [
        'admin_user_delete',
        'artist_delete',
...
export const OAuthClaimTypeSchema = {
    type: 'string',
    enum: [
        'normal'
    ]
...
export const OAuthIDTokenSigningAlgValueSchema = {
    type: 'string',
    enum: [
        'RS256'
    ]
...
export const OAuthPermissionSchema = {
    type: 'string',
    enum: [
        'can_approve_posts',
        'can_upload_free',
        ...
        'can_handle_takedowns',
        'can_edit_avoid_posting_entries',
        'is_blocked',
        'is_member',
        'is_privileged',
        'is_former_staff',
...
export const OAuthSubjectTypeSchema = {
    type: 'string',
    enum: [
        'public'
    ]
...
export const OAuthTokenEndpointAuthMethodSchema = {
    type: 'string',
    enum: [
        'client_secret_basic',
        'client_secret_post'
...
export const PoolCategorySchema = {
    type: 'string',
    enum: [
        'collection',
        'series'
...
export const PostEventActionSchema = {
    type: 'string',
    enum: [
        'deleted',
        'undeleted',
...
export const PostReplacementStatusSchema = {
    type: 'string',
    enum: [
        'promoted',
        'approved',
...
export const StaffWikiRefRelatedTypeSchema = {
    type: 'string',
    enum: [
        'User',
        'Artist',
...
export const TagCategoryNamesSchema = {
    type: 'string',
    enum: [
        'general',
        'artist',
...
export const TagRequestStatusSchema = {
    oneOf: [
        {
            type: 'string',
            enum: [
...
export const UpDownMehFlipVoteSchema = {
    type: 'integer',
    enum: [
        2,
        1,
...
export const UserFeedbackCategorySchema = {
    type: 'string',
    enum: [
        'negative',
        'neutral',
...
export const UserLevelNameSchema = {
    type: 'string',
    enum: [
        'Anonymous',
        'Blocked',
...
export const WarningTypeSchema = {
    type: 'string',
    enum: [
        'warning',
        'record',
...
export const DBExportSchema = {
    ...
    properties: {
        name: {
            $ref: '#/components/schemas/DBExportName'
        },
        file_name: {
            type: 'string'
        },
...
export const EditHistorySchema = {
    ...
    properties: {
        ...
        versionable_type: {
            $ref: '#/components/schemas/EditHistoryVersionableType'
        },
        versionable_id: {
            type: 'integer'
        },
...
export const ForumPostVoteSchema = {
    ...
    properties: {
        ...
        score: {
            $ref: '#/components/schemas/UpDownMehFlipVote'
        },
        created_at: {
            type: 'string',
            format: 'date-time'
...
export const JWKSKeySchema = {
    ...
    properties: {
        ...
        alg: {
            $ref: '#/components/schemas/JWKSAlgorithm'
        },
        kid: {
            type: 'string',
            description: 'Key ID, matched against the `kid` header of a signed JWT to select the key that verifies it.'
        },
        n: {
            type: 'string',
...
export const MinimalUserSchema = {
    ...
    properties: {
        ...
        level_string: {
            $ref: '#/components/schemas/UserLevelName'
        },
        favorite_count: {
            type: 'integer'
        }
...
export const ModActionSchema = {
    ...
    properties: {
        ...
        action: {
            $ref: '#/components/schemas/ModActionAction'
        }
    }
} as const;
...
export const OAuthIntrospectionSchema = {
    type: 'object',
    required: [
        'active'
    ],
    description: 'Only `active` is present when the token is inactive/unknown - the other fields are omitted entirely.',
    properties: {
        active: {
            type: 'boolean'
        },
        scope: {
            type: 'string',
            description: 'Space-separated list of the token\'s granted scopes.'
        },
        client_id: {
            type: 'string',
            description: 'The `uid` of the OAuth application the token was issued to.'
        },
        token_type: {
            type: 'string',
            enum: [
        ...
        exp: {
            type: 'integer',
            description: 'Unix timestamp of when the token expires. Omitted for tokens that don\'t expire.'
        }
    }
} as const;
...
export const OAuthTokenSchema = {
    ...
    properties: {
        ...
        id_token: {
            type: 'string',
            description: 'A signed JWT containing the user\'s ID token claims. Present only when the `openid` scope was granted.'
        }
    }
} as const;

export const OAuthTokenInfoSchema = {
    type: 'object',
    required: [
        'resource_owner_id',
        'scope',
...
export const OAuthUserInfoSchema = {
    type: 'object',
    description: 'null properties are entriely absent',
    required: [
        'preferred_username',
        'name',
        'updated_at',
...
export const OpenIDConfigurationSchema = {
    ...
    properties: {
        ...
        response_modes_supported: {
            type: 'array',
            items: {
                $ref: '#/components/schemas/OAuthResponseMode'
            }
        },
        grant_types_supported: {
            type: 'array',
        ...
        subject_types_supported: {
            type: 'array',
            items: {
                $ref: '#/components/schemas/OAuthSubjectType'
            }
        },
        id_token_signing_alg_values_supported: {
            type: 'array',
            items: {
                $ref: '#/components/schemas/OAuthIDTokenSigningAlgValue'
            }
        },
        claim_types_supported: {
            type: 'array',
            items: {
                $ref: '#/components/schemas/OAuthClaimType'
            }
        },
        claims_supported: {
            type: 'array',
            items: {
                $ref: '#/components/schemas/OAuthClaim'
            }
        },
        code_challenge_methods_supported: {
            type: 'array',
...
export const PoolSchema = {
    ...
    properties: {
        ...
        category: {
            $ref: '#/components/schemas/PoolCategory'
        },
        post_ids: {
            type: 'array',
            items: {
...
export const PostSchema = {
    ...
    properties: {
        ...
        flags: {
            $ref: '#/components/schemas/PostFlags'
        },
        has: {
            $ref: '#/components/schemas/PostHas'
        },
        relationships: {
...
export const PostEventSchema = {
    ...
    properties: {
        ...
        action: {
            $ref: '#/components/schemas/PostEventAction'
        },
        created_at: {
            type: 'string',
            format: 'date-time'
...
export const PostFilesSchema = {
    ...
    properties: {
        meta: {
            $ref: '#/components/schemas/PostFilesMeta'
        },
        original: {
            $ref: '#/components/schemas/PostFilesOriginal'
        },
        preview: {
            $ref: '#/components/schemas/PostFilesPreview'
        },
        sample: {
            $ref: '#/components/schemas/PostFilesSample'
        }
    }
} as const;

export const PostFilesMetaSchema = {
    type: 'object',
    required: [
        'md5',
        'ext',
...
export const PostFilesOriginalSchema = {
    type: 'object',
    required: [
        'width',
        'height',
...
export const PostFilesPreviewSchema = {
    type: 'object',
    required: [
        'width',
        'height',
...
export const PostFilesSampleSchema = {
    type: 'object',
    required: [
        'width',
        'height',
...
export const PostReplacementSchema = {
    ...
    properties: {
        ...
        status: {
            $ref: '#/components/schemas/PostReplacementStatus'
        },
        reason: {
            type: 'string'
        },
...
export const PostStatsSchema = {
    ...
    properties: {
        score: {
            $ref: '#/components/schemas/PostStatsScore'
        },
        fav_count: {
            type: 'integer'
        },
...
export const PostStatsScoreSchema = {
    type: 'object',
    required: [
        'up',
        'down',
...
export const SearchTrendHourlySchema = {
    type: 'object',
    required: [
        'tag',
        'count',
...
export const StaffIPAddrIPListingSchema = {
    allOf: [
        {
            $ref: '#/components/schemas/StaffIPAddrSums'
        },
        {
            type: 'object',
            required: [
...
export const StaffIPAddrSumSchema = {
    type: 'object',
    description: 'Dictionary of ip address to count.',
    additionalProperties: {
        type: 'integer'
    }
} as const;

export const StaffIPAddrSumsSchema = {
    type: 'object',
    required: [
        'comment',
        'dmail',
    ...
    properties: {
        comment: {
            $ref: '#/components/schemas/StaffIPAddrSum'
        },
        blip: {
            $ref: '#/components/schemas/StaffIPAddrSum'
        },
        ...
        artist_version: {
            description: 'If `search[with_history]=true`',
            $ref: '#/components/schemas/StaffIPAddrSum'
        },
        note_version: {
            description: 'If `search[with_history]=true`',
...
export const StaffIPAddrUserListingSchema = {
    type: 'object',
    required: [
        'sums',
        'ip_addrs'
...
export const StatsSchema = {
    ...
    properties: {
        started: {
            type: 'string',
            format: 'date-time',
            description: 'When the first post was created.'
        },
        total_posts: {
            type: 'integer'
        },
        ...
        existing_posts: {
            type: 'integer',
            description: '`active_posts + deleted_posts`'
        },
        destroyed_posts: {
            type: 'integer'
        },
        ...
        active_users: {
            type: 'integer',
            description: 'Users who have logged in within the last 3 months.'
        },
        total_comments: {
            type: 'integer'
        },
...
export const TagAliasSchema = {
    ...
    properties: {
        ...
        status: {
            $ref: '#/components/schemas/TagRequestStatus'
        },
        post_count: {
            type: 'integer'
        },
...
export const TrackedSearchTrendSchema = {
    type: 'object',
    required: [
        'count',
        'day'
...
export const UserAltSchema = {
    ...
    properties: {
        ...
        user: {
            $ref: '#/components/schemas/UserAltUser',
            nullable: true
        }
    }
} as const;

export const UserAltUserSchema = {
    type: 'object',
    required: [
        'id',
        'name',
...
export const IQDBResponseV2Schema = {
    type: 'object',
    required: [
        'hash',
        'post_id',
...
export const OAuthErrorSchema = {
    ...
    properties: {
        error: {
            type: 'string',
            description: 'OAuth 2.0 error code (RFC 6749 §5.2 / RFC 6750 §3), e.g. `invalid_token`.'
        },
        error_description: {
            type: 'string'
        },
