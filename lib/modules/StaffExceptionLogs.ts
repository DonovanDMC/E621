...
export interface SearchStaffExceptionLogsOptions extends TransformDataQueryToOptions<StaffExceptionsIndexData> {}

/** @category Modules */
export default class StaffExceptionLogs extends Base {
    static readonly moduleKey = "staffExceptionLogs" as const;
    ...
    async search(options?: SearchStaffExceptionLogsOptions): Promise<Array<ExceptionLog>> {
